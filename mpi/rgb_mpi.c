...
int main(int argc, char** argv) {
        ...
        for (int i = 0; i < GENERATION; i++) {
                ...
                convolute_rgb(block_array_bef, block_array_after, h, 1, rows_per_block, 1, cols_per_block,cols_per_block,rows_per_block);
                ...
                while (1) {
                        if (north_proc != -1) {
                                ...
                                if (flag1 == 1) {
                                        ...
                                        convolute_rgb(block_array_bef, block_array_after, h, 1, 1, 1, cols_per_block, cols_per_block,rows_per_block);
                        ...
                        if (south_proc != -1) {
                                ...
                                if (flag2 == 1) {
                                        ...
                                        convolute_rgb(block_array_bef, block_array_after, h, rows_per_block, rows_per_block, 1, cols_per_block, cols_per_block,rows_per_block);
                                        flag22=1;
                                }
                        }
                        else{
                ...
                if (west_proc != -1) {
                        ...
                        convolute_rgb(block_array_bef, block_array_after, h, 1, rows_per_block, 1, 1, cols_per_block,rows_per_block);
                }
                if (east_proc != -1) {
                        ...
                        convolute_rgb(block_array_bef, block_array_after, h, 1, rows_per_block, cols_per_block, cols_per_block, cols_per_block,rows_per_block);
                }
                if (north_proc != -1) {
                        MPI_Wait(&recv_row_n, &status);
                        // convolute_grey(block_array_bef, block_array_after, h, 1, 1, 1, cols_per_block, cols_per_block,rows_per_block);
